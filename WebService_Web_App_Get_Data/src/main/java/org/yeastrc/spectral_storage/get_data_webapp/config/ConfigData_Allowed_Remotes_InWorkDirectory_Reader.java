...
public class ConfigData_Allowed_Remotes_InWorkDirectory_Reader {
	...
	private static String ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY = "SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY";
	...
	private static String ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_OVERALL = "SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_OVERALL";
	
	private static String PROPERTY_NAME__ALLOWED_REMOTE_IPS_ADMIN = "allowed.remote.ips.admin";
	private static String ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_ADMIN = "SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_ADMIN";
	
	private static String PROPERTY_NAME__ALLOWED_REMOTE_IPS_QUERY = "allowed.remote.ips.query";
	private static String ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_QUERY = "SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_QUERY";
	...
	public void readConfigDataInWebApp() throws Exception {
		...
		try {
			...
			{  //   Access Allowed for all remote IP Addresses, for Update and Importer
				...
				String valueFoundInLabel_String = System.getenv( ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY );
				...
				if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
					if ( PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY.equals( valueFoundInLabel_String ) ) {
						
						configData_Allowed_Remotes_InWorkDirectory.setAccessAllowed_allRemoteIps_query(true);

						log.warn( "INFO: Environment Variable '" + ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
						...
						log.warn( "INFO: Environment Variable '" + ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
								+ "' NOT HAVE value '" + PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
					...
					valueFoundInLabel_String = prop.getProperty(ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY);
					...
					if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
						...
						if ( PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY.equals( valueFoundInLabel_String ) ) {
							...
							log.warn( "INFO: JVM param: '-D" + ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
									+ "' has value '" + PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
									+ "' so setting flag to true to allow connections from any IP address for Update and Importer" );
						} else {
						...
						if ( propertiesFile_Properties != null ) {
							valueFoundInLabel_String = propertiesFile_Properties.getProperty( PROPERTY_NAME__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY );
							...
							if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
								...
								if ( PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY.equals( valueFoundInLabel_String ) ) {
									...
									log.warn( "INFO: Properties File has value for Property '" + PROPERTY_NAME__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
											+ "' has value '" + PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
											+ "' so setting flag to true to allow connections from any IP address for Update and Importer" );
								} else {
								...
								if ( propertiesFile_Properties != null ) {
									valueFoundInLabel_String = propertiesFile_DEFAULT_Properties.getProperty( PROPERTY_NAME__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY );
									...
									if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
										...
										if ( PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY.equals( valueFoundInLabel_String ) ) {
											...
											log.warn( "INFO: Default Properties File has value for Property '" + PROPERTY_NAME__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
													+ "' has value '" + PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_QUERY 
													+ "' so setting flag to true to allow connections from any IP address for Update and Importer" );
										} else {
			...
			{  //   Access Allowed for remote IP Addresses, for All Requests
				...
				String valueFoundInLabel_String = System.getenv( ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_OVERALL );
				...
				if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
					...
					message_Label = "Environment Variable: '" 
							+ ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_OVERALL 
							+ "'";
				} else {
					...
					Properties prop = System.getProperties();
					valueFoundInLabel_String = prop.getProperty(ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_OVERALL);
			...
			{  //   Access Allowed for remote IP Addresses, for Admin Requests
				...
				String valueFoundInLabel_String = System.getenv( ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_ADMIN );
				...
				if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
					...
					message_Label = "Environment Variable: '" 
							+ ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_ADMIN 
							+ "'";
				} else {
					...
					Properties prop = System.getProperties();
					valueFoundInLabel_String = prop.getProperty(ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_ADMIN);
			...
			{  //   Access Allowed for remote IP Addresses, for Update Requests
				...
				String valueFoundInLabel_String = System.getenv( ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_QUERY );
				...
				if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
					...
					message_Label = "Environment Variable: '" 
							+ ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_QUERY 
							+ "'";
				} else {
					...
					Properties prop = System.getProperties();
					valueFoundInLabel_String = prop.getProperty(ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_QUERY);
					...
					if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
						...
						if ( propertiesFile_Properties != null ) {
							valueFoundInLabel_String = propertiesFile_Properties.getProperty( PROPERTY_NAME__ALLOWED_REMOTE_IPS_QUERY  );
							...
							if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
								...
								message_Label = "Properties file key: '" 
										+ PROPERTY_NAME__ALLOWED_REMOTE_IPS_QUERY  
										+ "'";
							}
						} else {
							...
							if ( propertiesFile_DEFAULT_Properties != null ) {
								valueFoundInLabel_String = propertiesFile_DEFAULT_Properties.getProperty( PROPERTY_NAME__ALLOWED_REMOTE_IPS_QUERY  );
