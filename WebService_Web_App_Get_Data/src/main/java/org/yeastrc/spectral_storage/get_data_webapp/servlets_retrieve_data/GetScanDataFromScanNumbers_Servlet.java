		...
		try {
			...
			try {
				...
				if ( spectralFile_Reader == null ) {
					...
					singleScan_SubResponse_Factory_Parameters.setReturnScanPeakWithMaxIntensityIgnoringSanPeakFilters( get_ScanDataFromScanNumbers_Request.getReturnScanPeakWithMaxIntensityIgnoringSanPeakFilters() );
