 ...
 *
 */
public class ProcessScanFileThread_Stop_Servlet extends HttpServlet {

	private static final Logger log = LoggerFactory.getLogger(ProcessScanFileThread_Stop_Servlet.class);
	...
	/* (non-Javadoc)
	 * @see org.apache.struts.action.Action#execute(org.apache.struts.action.ActionMapping, org.apache.struts.action.ActionForm, jakarta.servlet.http.HttpServletRequest, jakarta.servlet.http.HttpServletResponse)
	 */
	@Override
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			A_BackgroundThreads_Containers_Manager.getSingletonInstance().getProcessScanFile_Thread_Container().stopAfterCurrentFile();

			try ( PrintWriter writer = response.getWriter() ) {
				writer.append( "Stopping Processing files after current file" );
			}
