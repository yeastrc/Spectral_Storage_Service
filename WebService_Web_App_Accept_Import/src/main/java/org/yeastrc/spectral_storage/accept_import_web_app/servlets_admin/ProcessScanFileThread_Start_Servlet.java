...
public class ProcessScanFileThread_Start_Servlet extends HttpServlet {
	...
	private static final Logger log = Logger.getLogger(ProcessScanFileThread_Start_Servlet.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			ProcessScanFileThread.getInstance().startIfStopped_ClearStopAfterCurrentFile();
