...
public class ConfigData_Allowed_Remotes_InWorkDirectory_Reader {
	...
	private static String ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER = "SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER";
	...
	private static String ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_UPDATE = "SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_UPDATE";
	
	private static String PROPERTY_NAME__ALLOWED_REMOTE_IPS_IMPORTER = "allowed.remote.ips.importer";
	private static String ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_IMPORTER = "SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_IMPORTER";
	...
	public void readConfigDataInWebApp() throws Exception {
		...
		try {
			...
			{  //   Access Allowed for all remote IP Addresses, for Update and Importer
				...
				String valueFoundInLabel_String = System.getenv( ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER );
				...
				if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
					if ( PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER.equals( valueFoundInLabel_String ) ) {
						...
						log.warn( "INFO: Environment Variable '" + ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER 
					...
					valueFoundInLabel_String = prop.getProperty(ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER);
					...
					if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
						...
						if ( PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER.equals( valueFoundInLabel_String ) ) {
							...
							log.warn( "INFO: JVM param: '-D" + ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE_ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER 
									+ "' has value '" + PROPERTY_VALUE__TRUE__ACCESS_ALLOWED_ALL_REMOTE_IPS_UPDATE_IMPORTER 
									+ "' so setting flag to true to allow connections from any IP address for Update and Importer" );
						} else {
			...
			{  //   Access Allowed for remote IP Addresses, for Update Requests
				...
				String valueFoundInLabel_String = System.getenv( ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_UPDATE );
				...
				if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
					...
					message_Label = "Environment Variable: '" 
							+ ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_UPDATE 
							+ "'";
				} else {
					...
					Properties prop = System.getProperties();
					valueFoundInLabel_String = prop.getProperty(ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_UPDATE);
			...
			{  //   Access Allowed for remote IP Addresses, for Importer Requests

				String finalValue_String = null;

				String message_Label = null;

				String valueFoundInLabel_String = System.getenv( ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_IMPORTER );
				...
				if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
					...
					message_Label = "Environment Variable: '" 
							+ ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_IMPORTER 
							+ "'";
				} else {
					...
					Properties prop = System.getProperties();
					valueFoundInLabel_String = prop.getProperty(ENVIRONMENT_VARIABLE__SPECTRAL_STORAGE___ALLOWED_REMOTE_IPS_IMPORTER);
					...
					if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
						...
						if ( propertiesFile_Properties != null ) {
							valueFoundInLabel_String = propertiesFile_Properties.getProperty( PROPERTY_NAME__ALLOWED_REMOTE_IPS_IMPORTER );
							...
							if ( StringUtils.isNotEmpty( valueFoundInLabel_String ) ) {
								...
								message_Label = "Properties file key: '" 
										+ PROPERTY_NAME__ALLOWED_REMOTE_IPS_IMPORTER 
										+ "'";
							}
						} else {
							...
							if ( propertiesFile_DEFAULT_Properties != null ) {
								valueFoundInLabel_String = propertiesFile_DEFAULT_Properties.getProperty( PROPERTY_NAME__ALLOWED_REMOTE_IPS_IMPORTER );
