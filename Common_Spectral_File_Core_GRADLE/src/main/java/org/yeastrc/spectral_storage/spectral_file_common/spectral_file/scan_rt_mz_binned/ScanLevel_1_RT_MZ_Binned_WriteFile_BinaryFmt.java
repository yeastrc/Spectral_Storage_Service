 ...
 * 
 * Tested the writing and is a bit smaller than GZIP JSON ( example is 15MB for this and 20MB for GZIP JSON on 533MB input mzML file)
 * 
...
public class ScanLevel_1_RT_MZ_Binned_WriteFile_BinaryFmt {
	 ...
	 * @throws Exception
	 */
	public void writeScanLevel_1_RT_MZ_Binned_File_BINARY( 
		...
		String filenameFinal =
				...
				.createSpectraStorage_ScanBinnedIntensityOn_RT_MZ__Binary_GZ_Filename(
						hash_String,
