 ...
 *
 */
public class SpectralFile_Index_File_Reader_V_004 {
	
	private static final short FILE_VERSION = StorageFile_Version_004_Constants.FILE_VERSION;
	 ...
	 * private constructor
	 */
	private SpectralFile_Index_File_Reader_V_004(){}
	public static SpectralFile_Index_File_Reader_V_004 getInstance( ) throws Exception {
		SpectralFile_Index_File_Reader_V_004 instance = new SpectralFile_Index_File_Reader_V_004();
		return instance;
	}
	 ...
	 * @throws Exception
	 */
	public SpectralFile_Index_TDFR_FileContents_Root_V_004 readIndexFile( 
			String hash_String, 
			CommonReader_File_And_S3 commonReader_File_And_S3 ) throws Exception {

		SpectralFile_Index_TDFR_FileContents_Root_V_004 spectralFile_Index_FileContents = new SpectralFile_Index_TDFR_FileContents_Root_V_004();

		List<SpectralFile_Index_TDFR_SingleScan_V_004> indexScanEntries = new ArrayList<>();
		...
		try {
			...
			try ( DataInputStream dataInputStream_IndexFile = 
				...
				List<SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004> summaryDataPerScanLevelList = new ArrayList<>( distinctScanLevelValuesCount );
				...
				for ( byte scanLevelIndex = 0; scanLevelIndex < distinctScanLevelValuesCount; scanLevelIndex++ ) {
					SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004 summaryDataPerScanLevel = new SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004();
				...
				SpectralFile_Index_TDFR_SingleScan_V_004 spectralFile_Index_TDFR_SingleScan_PREV = null; // prev scan
				
				//  Process single scans in index
				SpectralFile_Index_TDFR_SingleScan_V_004 spectralFile_Index_TDFR_SingleScan = null;
	 ...
	 */
	private SpectralFile_Index_TDFR_SingleScan_V_004 readSingleIndexScanEntry( 
			DataInputStream dataInputStream_IndexFile,
			SpectralFile_Index_TDFR_SingleScan_V_004 spectralFile_Index_TDFR_SingleScan_PREV,
		...
		try {
			if ( scanSizeType == SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_SIZE_TYPE_INT ) {
			...
			} else if ( scanSizeType == SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_SIZE_TYPE_BYTE ) {
		...
		SpectralFile_Index_TDFR_SingleScan_V_004 spectralFile_Index_TDFR_SingleScan = new SpectralFile_Index_TDFR_SingleScan_V_004();
		...
		int scanNumberOffset = SpectralFile_Index_Header_DTO_V_004__Constants.FIRST_SINGLE_SCAN_SCAN_NUMBER_NOT_SET;

		if ( scanNumberOffsetType == SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_NONE__SCAN_NUMBER_OFFSET_ALWAYS_DEFAULT_1 ) {
			//  Default is 1 and is not in file per scan. 
			scanNumberOffset = SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_DEFAULT_1;
			
		} else if ( scanNumberOffsetType == SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_INT ) {
			scanNumberOffset = dataInputStream_IndexFile.readInt();
		} else if ( scanNumberOffsetType == SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_SHORT ) {
			scanNumberOffset = dataInputStream_IndexFile.readShort();
		} else if ( scanNumberOffsetType == SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_BYTE ) {
