 ...
 *
 */
public class SpectralFile_Index_TDFR_FileContents_Root_V_004 implements SpectralFile_Index_FileContents_Root_IF {
	 ...
	 */
	private List<SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004> summaryDataPerScanLevelList;
	 ...
	 */
	private List<SpectralFile_Index_TDFR_SingleScan_V_004> indexScanEntries;
...
//	private boolean scansAreInRetentionTimeOrder;
	 ...
	 * @return
	 */
	public SpectralFile_Index_TDFR_SingleScan_V_004 get_SingleScan_ForScanNumber( int scanNumber ) {

		SpectralFile_Index_TDFR_SingleScan_V_004 searchKey = new SpectralFile_Index_TDFR_SingleScan_V_004();
		...
		SpectralFile_Index_TDFR_SingleScan_V_004 indexEntry = indexScanEntries.get( searchKeyIndex );
...
//
	 ...
	 * @return
	 */
	public List<SpectralFile_Index_TDFR_SingleScan_V_004> getScansIndexRecordsForRetentionTimeRange( 
			float retentionTimeStart, 
			float retentionTimeEnd,
			Byte scanLevel // Optional
			) {
		...
		List<SpectralFile_Index_TDFR_SingleScan_V_004> scansInRange = new ArrayList<>();
...
//
	 ...
	 * @return
	 */
	public List<SpectralFile_Index_TDFR_SingleScan_V_004> getIndexScanEntries() {
	 ...
	 */
	public void setIndexScanEntries(List<SpectralFile_Index_TDFR_SingleScan_V_004> indexScanEntries) {
	 ...
	 * @return
	 */
	public List<SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004> getSummaryDataPerScanLevelList() {
		return summaryDataPerScanLevelList;
	}
	public void setSummaryDataPerScanLevelList(
			List<SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004> summaryDataPerScanLevelList) {
