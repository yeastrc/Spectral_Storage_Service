package org.yeastrc.spectral_storage.spectral_file_common.spectral_file.storage_files_on_disk.version_004.index_file.reader_writer;
...
import org.yeastrc.spectral_storage.spectral_file_common.spectral_file.storage_files_on_disk.version_004.index_file.constants.SpectralFile_Index_Header_DTO_V_004__Constants;
 ...
 *
 */
public class SpectralFile_Index_File_Writer_V_004 {

	private static final Logger log = LoggerFactory.getLogger(SpectralFile_Index_File_Writer_V_004.class);

	/**
	 * Version for Index File, written at beginning of the file
	 */
	public static final short FILE_VERSION = StorageFile_Version_004_Constants.FILE_VERSION;
	 ...
	 * private constructor
	 */
	private SpectralFile_Index_File_Writer_V_004(){}
	public static SpectralFile_Index_File_Writer_V_004 getInstance( ) throws Exception {
		SpectralFile_Index_File_Writer_V_004 instance = new SpectralFile_Index_File_Writer_V_004();
		return instance;
	}
	 ...
	 * @param spectralFile_Index_FDFW_FileContents_Root_V_004
	 * @throws Exception
	 */
	public void writeIndexFile( 
			String hash_String,
			File subDirForStorageFiles,
			SpectralFile_Index_FDFW_FileContents_Root_V_004 spectralFile_Index_FDFW_FileContents_Root_V_004,
		...
		List<SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004> summaryDataPerScanLevelList = new ArrayList<>( accumulateSummaryDataPerScanLevelResult.getSummaryDataPerScanLevelList().size() );
		for ( AccumulateSummaryDataPerScanLevelSingleLevelResult summaryDataPerScanLevelEntry : accumulateSummaryDataPerScanLevelResult.getSummaryDataPerScanLevelList() ) {
			SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004 tdfr_item = new SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004();
		...
		List<SpectralFile_Index_TDFR_SingleScan_V_004> indexScanEntries = new ArrayList<>( spectralFile_Index_FDFW_FileContents_Root_V_004.getIndexScanEntries().size() );
		for ( SpectralFile_Index_FDFW_SingleScan_V_004 fdf_SS : spectralFile_Index_FDFW_FileContents_Root_V_004.getIndexScanEntries() ) {
			SpectralFile_Index_TDFR_SingleScan_V_004 tdfr_SS = new SpectralFile_Index_TDFR_SingleScan_V_004();
		...
		//  call writeIndexFile(...) with populated SpectralFile_Index_TDFR_FileContents_Root_V_004 object
		SpectralFile_Index_TDFR_FileContents_Root_V_004 spectralFile_Index_TDFR_FileContents_Root_V_004 = new SpectralFile_Index_TDFR_FileContents_Root_V_004();
		
		spectralFile_Index_TDFR_FileContents_Root_V_004.setTotalBytesForAllSingleScans( spectralFile_Index_FDFW_FileContents_Root_V_004.getTotalBytesForAllSingleScans() );
		spectralFile_Index_TDFR_FileContents_Root_V_004.setSummaryDataPerScanLevelList( summaryDataPerScanLevelList );
		spectralFile_Index_TDFR_FileContents_Root_V_004.setIndexScanEntries( indexScanEntries );

		writeIndexFile( hash_String, subDirForStorageFiles, spectralFile_Index_TDFR_FileContents_Root_V_004 );
	}
	
	/**
	 * @param hash_String
	 * @param subDirForStorageFiles
	 * @param spectralFile_Index_TDFR_FileContents_Root_V_004
	 * @throws Exception
	 */
	public void writeIndexFile( 
			String hash_String,
			File subDirForStorageFiles,
			SpectralFile_Index_TDFR_FileContents_Root_V_004 spectralFile_Index_TDFR_FileContents_Root_V_004 ) throws Exception {
		...
		List<SpectralFile_Index_TDFR_SingleScan_V_004> indexScanEntries = spectralFile_Index_TDFR_FileContents_Root_V_004.getIndexScanEntries();
				

		/**
		 * summary per distinct scan level
		 */
		List<SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004> summaryDataPerScanLevelList = spectralFile_Index_TDFR_FileContents_Root_V_004.getSummaryDataPerScanLevelList();
		...
		byte scanNumberOffsetType = SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_INT;
		byte scanSizeType = SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_SIZE_TYPE_INT;
		...
		if ( ! indexScanEntries.isEmpty() ) {
			...
			{
				SpectralFile_Index_TDFR_SingleScan_V_004 prevScan = null;
				for ( SpectralFile_Index_TDFR_SingleScan_V_004 indexScanEntry : indexScanEntries ) {
					if ( prevScan != null ) {
...
//									+ ", indexScanEntry.getScanNumber(): " + indexScanEntry.getScanNumber() );
			...
			if ( scanNumberOffsetAlways_One ) {
				...
				scanNumberOffsetType = SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_NONE__SCAN_NUMBER_OFFSET_ALWAYS_DEFAULT_1;
			} else if ( largestScanNumberOffsetFromPrev <= Byte.MAX_VALUE && mostNegativeScanNumberOffsetFromPrev >= Byte.MIN_VALUE ) {
				scanNumberOffsetType = SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_BYTE;
			} else if ( largestScanNumberOffsetFromPrev <= Short.MAX_VALUE && mostNegativeScanNumberOffsetFromPrev >= Short.MIN_VALUE ) {
				scanNumberOffsetType = SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_SHORT;
			}
			
			if ( largestScanSizeInBytes < Byte.MAX_VALUE ) {
				scanSizeType = SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_SIZE_TYPE_BYTE;
			} else if ( largestScanSizeInBytes < Short.MAX_VALUE ) {
				scanSizeType = SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_SIZE_TYPE_SHORT;
			}
			
		}

		int first_SingleScan_ScanNumber = SpectralFile_Index_Header_DTO_V_004__Constants.FIRST_SINGLE_SCAN_SCAN_NUMBER_NOT_SET;
		
		long first_SingleScan_FileIndex = SpectralFile_Index_Header_DTO_V_004__Constants.FIRST_SINGLE_SCAN_FILE_INDEX_NOT_SET;

		{
			SpectralFile_Index_TDFR_SingleScan_V_004 firstScan = null;
		...
		try ( DataOutputStream dataOutputStream_IndexFile = 
			...
			for ( SpectralFile_Index_TDFR_SummaryDataPerScanLevel_V_004 summaryDataPerScanLevelEntry : summaryDataPerScanLevelList ) {
			...
			dataOutputStream_IndexFile.writeLong( spectralFile_Index_TDFR_FileContents_Root_V_004.getTotalBytesForAllSingleScans() );
			...
			for ( SpectralFile_Index_TDFR_SingleScan_V_004 indexScanEntry : indexScanEntries ) {
				...
				if ( scanSizeType == SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_SIZE_TYPE_BYTE ) {
					dataOutputStream_IndexFile.writeByte( scanSize_InDataFile_InBytes );
				} else if ( scanSizeType == SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_SIZE_TYPE_SHORT ) {
				...
				if ( scanNumberOffsetType ==
						SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_NONE__SCAN_NUMBER_OFFSET_ALWAYS_DEFAULT_1 ) {
					...
					if ( scanNumberOffsetType == 
							SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_BYTE ) {
						dataOutputStream_IndexFile.writeByte( scanNumber_Offset );
					} else if ( scanNumberOffsetType == 
							SpectralFile_Index_Header_DTO_V_004__Constants.SCAN_NUMBER_OFFSET_TYPE_SHORT ) {
