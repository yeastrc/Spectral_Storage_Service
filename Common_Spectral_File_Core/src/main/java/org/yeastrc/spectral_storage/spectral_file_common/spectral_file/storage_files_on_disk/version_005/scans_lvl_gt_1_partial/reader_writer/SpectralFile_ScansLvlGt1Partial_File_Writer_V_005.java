 ...
 *
 */
public class SpectralFile_ScansLvlGt1Partial_File_Writer_V_005 {

	private static final Logger log = LoggerFactory.getLogger(SpectralFile_ScansLvlGt1Partial_File_Writer_V_005.class);
	 ...
	 * private constructor
	 */
	private SpectralFile_ScansLvlGt1Partial_File_Writer_V_005(){}
	public static SpectralFile_ScansLvlGt1Partial_File_Writer_V_005 getInstance( ) throws Exception {
		SpectralFile_ScansLvlGt1Partial_File_Writer_V_005 instance = new SpectralFile_ScansLvlGt1Partial_File_Writer_V_005();
		return instance;
	}
...
//		int first_SingleScan_ScanNumber = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.FIRST_SINGLE_SCAN_SCAN_NUMBER_NOT_SET;
//		
//		byte scanNumberOffsetType = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.SCAN_NUMBER_OFFSET_TYPE_INT;
		
//		boolean scanNumberOffsetAlways_One = true;
		
		byte parentScanNumberOffsetType = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_INT;
...
//			int mostNegativeScanNumberOffsetFromPrev = 0;
			...
			{
				SpectralFile_Index_FDFW_SingleScan_V_005 prevScan = null;
...
//					if ( first_SingleScan_ScanNumber == SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.FIRST_SINGLE_SCAN_SCAN_NUMBER_NOT_SET ) {
...
//				scanNumberOffsetType = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.SCAN_NUMBER_OFFSET_TYPE_NONE__SCAN_NUMBER_OFFSET_ALWAYS_DEFAULT_1;
//			} else if ( largestScanNumberOffsetFromPrev <= Byte.MAX_VALUE && mostNegativeScanNumberOffsetFromPrev >= Byte.MIN_VALUE ) {
//				scanNumberOffsetType = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.SCAN_NUMBER_OFFSET_TYPE_BYTE;
//			} else if ( largestScanNumberOffsetFromPrev <= Short.MAX_VALUE && mostNegativeScanNumberOffsetFromPrev >= Short.MIN_VALUE ) {
//				scanNumberOffsetType = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.SCAN_NUMBER_OFFSET_TYPE_SHORT;
//			}
			
			if ( parentScanNumberOffsetAlways_Negative_One ) {
				//  scanNumberOffset is always 1 so not needed per scan
				parentScanNumberOffsetType = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_NONE__PARENT_SCAN_NUMBER_OFFSET_ALWAYS_DEFAULT_NEGATIVE_1;
				...
				parentScanNumberOffsetType = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_BYTE;
				...
				parentScanNumberOffsetType = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_SHORT;
			}
		}
...
//						SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.SCAN_NUMBER_OFFSET_TYPE_NONE__SCAN_NUMBER_OFFSET_ALWAYS_DEFAULT_1 ) {
...
//
//					if ( scanNumberOffsetType == 
//							SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.SCAN_NUMBER_OFFSET_TYPE_BYTE ) {
//						dataOutputStream_IndexFile.writeByte( scanNumber_Offset );
//					} else if ( scanNumberOffsetType == 
//							SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.SCAN_NUMBER_OFFSET_TYPE_SHORT ) {
...
//				}
				...
				if ( parentScanNumberOffsetType ==
						SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_NONE__PARENT_SCAN_NUMBER_OFFSET_ALWAYS_DEFAULT_NEGATIVE_1 ) {
					// do not write scanNumber_Offset value to file since always -1
				} else {
					int parentScanNumberOffset = indexScanEntry.getParentScanNumber() - indexScanEntry.getScanNumber();

					if ( parentScanNumberOffsetType == 
							SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_BYTE ) {
						dataOutputStream_ToOutputFile.writeByte( parentScanNumberOffset );
					} else if ( parentScanNumberOffsetType == 
							SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_SHORT ) {
		...
		updateFileFullyWrittenIndicatorUpdateAfterFullCloseMainWriter( scansLvlGt1PartialFileWhileWriting, spectralFile_Index_FDFW_FileContents_Root_V_005 );
