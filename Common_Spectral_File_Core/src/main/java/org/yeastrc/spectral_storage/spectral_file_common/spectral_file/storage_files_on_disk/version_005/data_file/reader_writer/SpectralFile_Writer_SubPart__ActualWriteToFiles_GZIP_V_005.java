 ...
 *
 * Old History of much of this code is in class SpectralFile_Writer_GZIP_V_005
 * 
 */
class SpectralFile_Writer_SubPart__ActualWriteToFiles_GZIP_V_005 {

	private static final Logger log = LoggerFactory.getLogger(SpectralFile_Writer_SubPart__ActualWriteToFiles_GZIP_V_005.class);
	 ...
	 * @return
	 */
	boolean isProcessingIs_Successfull_And_Complete() {
	 ...
	 * private constructor
	 */
	private SpectralFile_Writer_SubPart__ActualWriteToFiles_GZIP_V_005(){}
	/**
	 * Package Private getter
	 * 
	 * @return
	 * @throws Exception
	 */
	static SpectralFile_Writer_SubPart__ActualWriteToFiles_GZIP_V_005 getNewInstance( ) throws Exception {
		SpectralFile_Writer_SubPart__ActualWriteToFiles_GZIP_V_005 instance = new SpectralFile_Writer_SubPart__ActualWriteToFiles_GZIP_V_005();
		return instance;
	}
	 ...
	 * @param spectralFile_Header_Common
	 * @param notifyOnProcessingCompleteOrException
	 * @throws Exception
	 */
