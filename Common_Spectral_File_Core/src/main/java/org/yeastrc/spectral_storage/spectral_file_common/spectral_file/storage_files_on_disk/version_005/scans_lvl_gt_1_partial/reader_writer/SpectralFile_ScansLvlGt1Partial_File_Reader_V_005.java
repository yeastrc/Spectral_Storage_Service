package org.yeastrc.spectral_storage.spectral_file_common.spectral_file.storage_files_on_disk.version_005.scans_lvl_gt_1_partial.reader_writer;
...
import org.yeastrc.spectral_storage.spectral_file_common.spectral_file.storage_files_on_disk.version_005.scans_lvl_gt_1_partial.constants.SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants;
 ...
 *
 */
public class SpectralFile_ScansLvlGt1Partial_File_Reader_V_005 {
	...
	private static final Logger log = LoggerFactory.getLogger(SpectralFile_ScansLvlGt1Partial_File_Reader_V_005.class);
	
	/**
	 * private constructor
	 */
	private SpectralFile_ScansLvlGt1Partial_File_Reader_V_005(){}
	public static SpectralFile_ScansLvlGt1Partial_File_Reader_V_005 getInstance( ) throws Exception {
		SpectralFile_ScansLvlGt1Partial_File_Reader_V_005 instance = new SpectralFile_ScansLvlGt1Partial_File_Reader_V_005();
		return instance;
	}
	 ...
	 * @throws Exception
	 */
	public SpectralFile_ScansLvlGt1Partial_TDFR_FileContents_Root_V_005 readScansLvlGt1PartialFile( 
			String hash_String, 
			CommonReader_File_And_S3 commonReader_File_And_S3 ) throws Exception {

		SpectralFile_ScansLvlGt1Partial_TDFR_FileContents_Root_V_005 spectralFile_Index_FileContents = new SpectralFile_ScansLvlGt1Partial_TDFR_FileContents_Root_V_005();

		try {
			List<SpectralFile_Index_TDFR_SingleScan_V_005> indexScanLevelGt1List =
			...
			try ( DataInputStream dataInputStream_IndexFile = 
				...
				List<SpectralFile_ScansLvlGt1Partial_TDFR_SingleScan_V_005> scanDataEntries = new ArrayList<>( perScanFromFileHolderList.size() );
				spectralFile_Index_FileContents.setScanDataEntries( scanDataEntries );

				Iterator<SpectralFile_Index_TDFR_SingleScan_V_005> indexScanLevelGt1Iter = indexScanLevelGt1List.iterator();
				
				for ( PerScanFromFileHolder perScanFromFileHolderItem : perScanFromFileHolderList ) {
					SpectralFile_Index_TDFR_SingleScan_V_005 indexScanLevelGt1Item = indexScanLevelGt1Iter.next();

					SpectralFile_ScansLvlGt1Partial_TDFR_SingleScan_V_005 spectralFile_Index_TDFR_SingleScan = new SpectralFile_ScansLvlGt1Partial_TDFR_SingleScan_V_005();
	...
	private PerScanFromFileHolder readSingleIndexScanEntry( 
		...
		try {
			...
			parentScanNumberOffset = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.FIRST_SINGLE_SCAN_PARENT_SCAN_NUMBER_NOT_SET;

			if ( parentScanNumberOffsetType == SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_NONE__PARENT_SCAN_NUMBER_OFFSET_ALWAYS_DEFAULT_NEGATIVE_1 ) {
				//  Default is -1 and is not in file per scan. 
				parentScanNumberOffset = SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_DEFAULT_NEGATIVE_1;
				
			} else if ( parentScanNumberOffsetType == SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_INT ) {
				parentScanNumberOffset = dataInputStream_ScansLvlGt1PartialFile.readInt();
			} else if ( parentScanNumberOffsetType == SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_SHORT ) {
				parentScanNumberOffset = dataInputStream_ScansLvlGt1PartialFile.readShort();
			} else if ( parentScanNumberOffsetType == SpectralFile_ScansLvlGt1Partial_Header_DTO_V_005__Constants.PARENT_SCAN_NUMBER_OFFSET_TYPE_BYTE ) {
	 ...
	 * @throws Exception
	 */
	private List<SpectralFile_Index_TDFR_SingleScan_V_005> get_indexScanEntries_OnlyLevelGt1InIndexFileOrder( String hash_String ) throws Exception {
		...
		List<SpectralFile_Index_TDFR_SingleScan_V_005> indexScanEntriesLevelGt1 = new ArrayList<>( indexScanEntriesAll.size() );
		
		for ( SpectralFile_Index_TDFR_SingleScan_V_005 item : indexScanEntriesAll ) {
			if ( item.getLevel() > 1 ) {
		...
		Collections.sort( indexScanEntriesLevelGt1, new Comparator<SpectralFile_Index_TDFR_SingleScan_V_005>() {
			@Override
