...
import org.yeastrc.spectral_storage.spectral_file_common.spectral_file.storage_files_on_disk.version_003.data_file.reader_writer.SpectralFile_Writer_GZIP_V_003;
...
public class SpectralFile_Writer_CurrentFormat_Factory {
	...
	public SpectralFile_Writer__IF getSpectralFile_Writer_LatestVersion() throws Exception {
		return SpectralFile_Writer_GZIP_V_003.getInstance();
	}
}
