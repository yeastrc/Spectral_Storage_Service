...
public class ConfigDataInWebApp_Reader {
	...
	private static final Logger log = Logger.getLogger(ConfigDataInWebApp_Reader.class);
	

	private static String CONFIG_DEFAULTS_FILENAME = "spectra_config_defaults.properties";
	private static String CONFIG_OVERRIDES_FILENAME = "spectra_config.properties";
