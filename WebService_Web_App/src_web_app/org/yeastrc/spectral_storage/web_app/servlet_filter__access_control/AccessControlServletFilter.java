 ...
 *
 */
public class AccessControlServletFilter implements Filter {
...
//		HttpServletRequest httpRequest = (HttpServletRequest) request;
		...
		if ( ! ConfigData_Allowed_Remotes_InWorkDirectory.getSingletonInstance().getAllowedRemoteIPs().contains( remoteAddr ) ) {
